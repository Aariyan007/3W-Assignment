        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="confirmPassword">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 11V6C9 4.67392 9.52678 3.40215 10.4645 2.46447C11.4021 1.52678 12.6739 1 14 1C15.3261 1 16.5979 1.52678 17.5355 2.46447C18.4732 3.40215 19 4.67392 19 6V11M5 11H23V22H5V11Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              Confirm
            </label>
            <input
